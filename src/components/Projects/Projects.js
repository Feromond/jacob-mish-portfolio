  ...
  const projects = [
    {
      ...
      description: 'Our goal with this ML pipeline template is to create a user friendly utility to drastically speed up the development and implementation of a machine learning model for all sorts of various problems.',
      imageUrl: mlProjectDemoImg,
      repoUrl: 'https://github.com/zamaniali1995/ml-pipeline'
    },
    {
      title: 'My Portfolio Website',
      description: 'My portfolio website which I created using React and some Material UI components to demonstrate some web development skills and have another medium to display my resume and projects',
      imageUrl: portfolioWebsiteImg,
      repoUrl: 'https://github.com/Feromond/jacob-mish-portfolio'
    },
    {
      title: 'Hypixel Bazzar API - Rust',
      description: 'Uses hypixel-api to grab bazaar item product information in near-real-time and displays the data visually in the command line.',
  ...
  return (
    <Container>
      <Box mt={4}>
        ...
        <Grid container spacing={4} component={motion.div} variants={staggerVariants} initial="hidden" animate="visible">
