...
const Experience = () => (
	<Container sx={{ marginTop: '30px' }}>
		<Typography variant="h2" sx={{ marginBottom: '20px', textAlign: 'left' }}>
			Experience
		</Typography>
						...
						>
							<CardContent>
								...
								<Typography variant="h6">
									{exp.duration} | {exp.company} | {exp.location}
								</Typography>
								<ul>
		...
		<div>
			...
			<List>
				<ListItem>
					<ListItemText primary="Medical Office Assistant" secondary="Dr. Noiles & Mish Medical Clinic" />
				</ListItem>
				<ListItem>
					<ListItemText primary="Pizza Restaurant Supervisor" secondary="Andaros Pizza" />
				</ListItem>
				<ListItem>
